...
import com.housingonitoringagent.homeworryagent.adapter.GuideImageAdapter;
...
//            dot.setImageResource(R.drawable.dot);
    ...
    public List<Integer> getImages() {
        ...
        images.add(R.mipmap.pic_splash);
        images.add(R.mipmap.pic_splash);
        return images;
    }
    ...
    private SharedPreferences getPregetPreferences() {
        return App.getInstance().getSharedPreferences(PreferencesKey.Guide.NAME, MODE_PRIVATE);
    }
